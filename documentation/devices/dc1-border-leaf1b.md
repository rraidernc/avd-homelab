...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.4.141/22 | 192.168.4.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BORDER_LEAF1 | Vlan4094 | 10.255.1.72 | Port-Channel3 |
...
| Ethernet4 | P2P_dc2-border-leaf1b_Ethernet4 | - | 172.100.100.2/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description MLAG_dc1-border-leaf1a_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description P2P_dc2-border-leaf1b_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
interface Port-Channel3
   description MLAG_dc1-border-leaf1a_Port-Channel3
   no shutdown
...
!
interface Vxlan1
   description dc1-border-leaf1b_VTEP
...
| 10.255.128.8 | 65203 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.255.0.8:10011 | 10011:10011<br>remote 10011:10011 | - | - | learned |
| 12 | 10.255.0.8:10012 | 10012:10012<br>remote 10012:10012 | - | - | learned |
| 21 | 10.255.0.8:10021 | 10021:10021<br>remote 10021:10021 | - | - | learned |
...
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 10.255.0.8:10 | connected<br>static | - |
| VRF11 | 10.255.0.8:11 | connected<br>static | - |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc1-border-leaf1a
   ...
   neighbor 10.255.1.104 description dc1-border-leaf1a_Vlan4093
   neighbor 10.255.128.8 peer group EVPN-OVERLAY-CORE
   ...
   neighbor 172.100.100.3 remote-as 65203
   neighbor 172.100.100.3 description dc2-border-leaf1b
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 11
      rd 10.255.0.8:10011
      rd evpn domain remote 10.255.0.8:10011
   ...
   vlan 12
      rd 10.255.0.8:10012
      rd evpn domain remote 10.255.0.8:10012
   ...
   vlan 21
      rd 10.255.0.8:10021
      rd evpn domain remote 10.255.0.8:10021
   ...
   vlan 22
      rd 10.255.0.8:10022
      rd evpn domain remote 10.255.0.8:10022
   ...
   vlan 3401
      rd 10.255.0.8:13401
      rd evpn domain remote 10.255.0.8:13401
   ...
   vlan 3402
      rd 10.255.0.8:13402
      rd evpn domain remote 10.255.0.8:13402
