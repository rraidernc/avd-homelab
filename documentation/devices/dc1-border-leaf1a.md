...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.4.140/22 | 192.168.4.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BORDER_LEAF1 | Vlan4094 | 10.255.1.73 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_dc1-border-leaf1b_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet5 | FIREWALL_mills-avd-fw_Et1 | *trunk | *3901-3902 | *- | *- | 5 |
...
| Ethernet4 | P2P_dc2-border-leaf1a_Ethernet4 | - | 172.100.100.0/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description MLAG_dc1-border-leaf1b_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description P2P_dc2-border-leaf1a_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description FIREWALL_mills-avd-fw_Et1
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_dc1-border-leaf1b_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_dc1-border-leaf1b_Port-Channel3
   no shutdown
...
!
interface Vxlan1
   description dc1-border-leaf1a_VTEP
...
| 10.255.128.7 | 65203 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.255.0.7:10011 | 10011:10011<br>remote 10011:10011 | - | - | learned |
| 12 | 10.255.0.7:10012 | 10012:10012<br>remote 10012:10012 | - | - | learned |
| 21 | 10.255.0.7:10021 | 10021:10021<br>remote 10021:10021 | - | - | learned |
| 22 | 10.255.0.7:10022 | 10022:10022<br>remote 10022:10022 | - | - | learned |
| 3401 | 10.255.0.7:13401 | 13401:13401<br>remote 13401:13401 | - | - | learned |
| 3402 | 10.255.0.7:13402 | 13402:13402<br>remote 13402:13402 | - | - | learned |
| 3901 | 10.255.0.7:13901 | 13901:13901<br>remote 13901:13901 | - | - | learned |
| 3902 | 10.255.0.7:13902 | 13902:13902<br>remote 13902:13902 | - | - | learned |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc1-border-leaf1b
   ...
   neighbor 10.255.1.105 description dc1-border-leaf1b_Vlan4093
   neighbor 10.255.128.7 peer group EVPN-OVERLAY-CORE
   ...
   neighbor 172.100.100.1 description dc2-border-leaf1a
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 11
      rd 10.255.0.7:10011
      rd evpn domain remote 10.255.0.7:10011
   ...
   vlan 12
      rd 10.255.0.7:10012
      rd evpn domain remote 10.255.0.7:10012
   ...
   vlan 21
      rd 10.255.0.7:10021
      rd evpn domain remote 10.255.0.7:10021
   ...
   vlan 22
      rd 10.255.0.7:10022
      rd evpn domain remote 10.255.0.7:10022
   ...
   vlan 3401
      rd 10.255.0.7:13401
      rd evpn domain remote 10.255.0.7:13401
   ...
   vlan 3402
      rd 10.255.0.7:13402
      rd evpn domain remote 10.255.0.7:13402
   ...
   vlan 3901
      rd 10.255.0.7:13901
      rd evpn domain remote 10.255.0.7:13901
   ...
   vlan 3902
      rd 10.255.0.7:13902
      rd evpn domain remote 10.255.0.7:13902
