...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.4.120/22 | 192.168.4.1 |
...
| Ethernet5 | P2P_dc1-border-leaf1a_Ethernet1 | - | 10.255.255.16/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_dc1-border-leaf1b_Ethernet1 | - | 10.255.255.20/31 | default | 1500 | False | - | - |
...
!
interface Ethernet5
   description P2P_dc1-border-leaf1a_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description P2P_dc1-border-leaf1b_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65100
   ...
   neighbor 10.255.255.17 description dc1-border-leaf1a_Ethernet1
   neighbor 10.255.255.21 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.21 remote-as 65103
   neighbor 10.255.255.21 description dc1-border-leaf1b_Ethernet1
