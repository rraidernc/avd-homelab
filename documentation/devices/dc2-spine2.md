...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.4.131/22 | 192.168.4.1 |
...
| Ethernet5 | P2P_dc2-border-leaf1a_Ethernet2 | - | 10.255.255.82/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_dc2-border-leaf1b_Ethernet2 | - | 10.255.255.86/31 | default | 1500 | False | - | - |
...
!
interface Ethernet5
   description P2P_dc2-border-leaf1a_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description P2P_dc2-border-leaf1b_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 10.255.255.86/31
```
...
| 10.255.255.83 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.255.87 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65200
   ...
   neighbor 10.255.255.83 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.83 remote-as 65203
   neighbor 10.255.255.83 description dc2-border-leaf1a_Ethernet2
   neighbor 10.255.255.87 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.87 remote-as 65203
   neighbor 10.255.255.87 description dc2-border-leaf1b_Ethernet2
